<form action="<?= Uri::create('email/create'); ?>" method="POST" accept-charset="utf-8">
<input type="hidden" name="template_id" value="<?=$template_id; ?>">
<input type="hidden" name="from_page" value="<?=$from_page; ?>">
<?if($yachtshare):?><input type="hidden" name="yachtshare_id" value="<?=$yachtshare->id;?>"><?endif;?>
<?if($buyer):?><input type="hidden" name="buyer_id" value="<?=$buyer->id;?>"><?endif;?>
