<div class="widget fluid">
    <div class="whead">
		<div>
			<h6>Reminder:</h6> <span style="display: inline-block; margin-top: 3px; padding: 5px 6px 4px 6px;">ACTIVE SINCE <?=Date::forge($yachtshare->reminder_expires_at)->format('%d/%m/%Y');?></span>
		</div>
		<div class="clear"></div>
	</div>
