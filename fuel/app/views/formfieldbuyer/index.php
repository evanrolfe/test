...
<div class="widget">
    <div class="whead">
		...
		<div style='text-align: right'>
			<a href="<?= Uri::create('formfieldbuyer/order/seller'); ?>" class="buttonS bBlue" style="margin: 6px 6px; color: white;">Change Order</a>
			<a href="<?= Uri::create('formfieldbuyer/create/seller'); ?>" class="buttonS bBlue" style="margin: 6px 6px; color: white;"><span class="icon-add"></span>New</a>
		</div>
		<div class="clear"></div>
	</div>
